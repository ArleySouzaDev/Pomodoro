...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        count_down(work_sec)
        title_label.config(text="Trabalho", fg=GREEN)
...
title_label = Label(text="Cronômetro", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 50, "bold"))
...
reset_button = Button(text="Resetar", highlightthickness=0, command=reset_timer)
